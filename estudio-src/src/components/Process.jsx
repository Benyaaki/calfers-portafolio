...
const steps = [
  {
    n: '01',
    title: 'Escuchamos',
    desc: 'Nos cuentas tu idea. Preguntamos y entendemos tu negocio, tus procesos y a tu equipo antes de escribir una sola línea de código.',
    blob: '42% 58% 63% 37% / 41% 44% 56% 59%',
  },
  {
    n: '02',
    title: 'Investigamos y diagramamos',
    desc: 'Mapeamos el problema y diseñamos el proceso antes de proponer una solución. Recién ahí definimos alcance, tiempos y una cotización clara.',
  ...
  },
  {
    ...
    desc: 'Dejamos todo funcionando y no desaparecemos: seguimos cerca para mejorar y dar soporte. Tu sistema no queda solo.',
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 shrink-0">
        <div
          className="animate-morph grid h-20 w-20 place-items-center bg-gradient-to-br from-lavender-300 to-peach-300 shadow-glow sm:h-32 sm:w-32"
      ...
      <div className="flex-1 pt-2 sm:pt-8">
        <h3 className="font-display text-xl font-medium leading-tight text-espresso sm:text-4xl">
          {step.title}
        </h3>
        <p className="mt-2 max-w-md text-[15px] leading-relaxed text-espresso/60 sm:text-lg">
          {step.desc}
        </p>
      </div>
    </motion.div>
  ...
  return (
    <section id="proceso" ref={ref} className="relative mx-auto max-w-3xl px-6 py-28 sm:py-40">
      ...
      <div className="relative">
        ...
        <div className="absolute left-10 top-10 bottom-10 w-[2px] -translate-x-1/2 bg-espresso/10 sm:left-16 sm:top-16 sm:bottom-16">
          <motion.div
            style={{ scaleY }}
